...
public interface OutboxEventFactoryMapper {
    ...
    @Mapping(target = "payload", expression = "java(\"{\\\"transactionId\\\":\\\"\" + transactionEntity.getPaymentTransactionId() + \"\\\",\" +\"\\\"amount\\\":\\\"\" + transactionEntity.getAmount() + \"\\\",\" +\"\\\"currency\\\":\\\"\" + transactionEntity.getCurrency() + \"\\\"}\" +\"\\\"userId\\\":\\\"\" + transactionEntity.getUserId() + \"\\\"}\")")
